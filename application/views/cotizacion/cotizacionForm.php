		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form">
				...
				<div class="wrap-input100 validate-input bg1" data-validate="Please Type Your Name">
					...
					<input class="input100" type="number" name="id" placeholder="Id Cotización" value="<?=$cotizacion[0]['id']?>" readonly>
				</div>

				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100">
					<span class="label-input100">Marca *</span>
					<input class="input100" type="text" name="marca" placeholder="Toyota">
				</div>
                ...
                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100">
					...
					<input class="input100" type="text" name="precio" placeholder="$00.00">
                </div>
                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100">
					<span class="label-input100">No. Serie *</span>
					<input class="input100" type="text" name="nserie" placeholder="10MNZ3457KGFS">
                </div>
                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100">
					<span class="label-input100">Clave Vehicular *</span>
					<input class="input100" type="text" name="clave" placeholder="10MNZ3457KGFS10">
                </div>
                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100">
					<span class="label-input100">En inventario *</span>
					<input class="input100" type="text" name="inventario" placeholder="Ej. 5 unidades">
				</div>
