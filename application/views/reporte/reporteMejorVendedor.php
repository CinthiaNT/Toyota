...
function Contenido($vendedor){
    ...
    $this->SetLineWidth(0);
    $this->SetFont('','B');
    $this->Cell(190,8,$vendedor[0]['name'].' '.$vendedor[0]['ap'],'LR',0,'C',true);
    $this->Ln(20);
    $this->SetFillColor(255);
    $this->SetTextColor(0);
    $this->SetFont('arial','',10);
    $this->Cell(190,10,'Equipo Toyota felicita a '.$vendedor[0]['name'].' '.$vendedor[0]['ap'].' por obtener el premio a mejor vendedor 2019','',0,'C',FALSE);
    $this->Ln();
